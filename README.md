...
### Pretrained Weights
If for some reason you want to download a 23M parameter model that generates confident gibberish, the weights are available on Hugging Face: **[Pratik-3706/StupidLm](https://huggingface.co/Pratik-3706/StupidLm)**. Don't say I didn't warn you.
